...
def train(
        # model/data params
        gate_or_adapter: str = "gate",
        base_model: str = "",  # the only required argument
        data_path: str = "/data/liruizhe/gate_proj/data/natural-instructions-2.8/tasks",
    ...
    print(
        ...
        f"gate_or_adapter: {gate_or_adapter}\n"
    )
    assert (
        base_model
    ...
    def generate_and_tokenize_prompt(data_point,tokenizer=tokenizer):
        full_prompt = generate_prompt(data_point,tokenizer)
    ...
    print("gate_or_adapter:",gate_or_adapter)
    if gate_or_adapter=='gate':
...
def generate_prompt(data_point,tokenizer):
    ...
    return f"""Below is an instruction that describes a task. Write a response that appropriately completes the request.  
                ...
                ### Response:
                {data_point["messages"][1]["content"]}""" # noqa: E501

    # return f""" {data_point["messages"][0]["content"]} 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gate_or_adapter', type=str, default='gate',choices=['gate','adapter'])
    ...
    train(base_model=args.base_model,data_path=args.data_path,output_dir=args.output_dir,batch_size=args.batch_size,
          micro_batch_size=args.micro_batch_size,num_epochs=args.num_epochs,learning_rate=args.learning_rate,cutoff_len=args.cutoff_len,target_modules=args.target_modules,
          ...
          gate_or_adapter=args.gate_or_adapter)

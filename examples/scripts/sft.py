...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="/data/liruizhe/trans_result")
    ...
    tokenizer = AutoTokenizer.from_pretrained(model_config.model_name_or_path, use_fast=True,cache_dir="/data/liruizhe/trans_1")
